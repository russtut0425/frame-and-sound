...
function openForm(entry=null){
  const form=$("#entry-form");form.reset();form.elements.loggedDate.value=new Date().toISOString().slice(0,10);form.elements.rating.value="";form.elements.type.value="film";form.elements.id.value="";pendingImage=imageOf(entry||{});$("#entry-image").value="";updateImagePreview();
